...
CREATE TABLE `dhl_easylog1` (
  ...
  `unknown3` varchar(60) collate latin1_general_ci default NULL,
  ...
  `unknown4` varchar(25) collate latin1_general_ci default NULL,
  ...
  PRIMARY KEY  (`stockno`,`credate`,`carrierboxno`,`lgmboxno`,`shipmewntno`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1 COLLATE=latin1_general_ci;
